...
namespace Cube {
    ...
    GLint vertices[NUM_CUBE_VERTICES][3] = {
      {-24,  -6,  -6}, {-24,  -6,   6}, {-24,   6,  -6}, {-24,   6,   6},
      {-20, -15,   0}, {-20,   0, -15}, {-20,   0,  15}, {-20,  15,   0},
      {-18, -15,  -9}, {-18, -15,   9}, {-18,  -9, -15}, {-18,  -9,  15},
      {-18,   9, -15}, {-18,   9,  15}, {-18,  15,  -9}, {-18,  15,   9},
      {-15, -20,   0}, {-15, -18,  -9}, {-15, -18,   9}, {-15,  -9, -18},
      {-15,  -9,  18}, {-15,   0, -20}, {-15,   0,  20}, {-15,   9, -18},
      {-15,   9,  18}, {-15,  18,  -9}, {-15,  18,   9}, {-15,  20,   0},
      { -9, -18, -15}, { -9, -18,  15}, { -9, -15, -18}, { -9, -15,  18},
      { -9,  15, -18}, { -9,  15,  18}, { -9,  18, -15}, { -9,  18,  15},
      { -6, -24,  -6}, { -6, -24,   6}, { -6,  -6, -24}, { -6,  -6,  24},
      { -6,   6, -24}, { -6,   6,  24}, { -6,  24,  -6}, { -6,  24,   6},
      {  0, -20, -15}, {  0, -20,  15}, {  0, -15, -20}, {  0, -15,  20},
      {  0,  15, -20}, {  0,  15,  20}, {  0,  20, -15}, {  0,  20,  15},
      {  6, -24,  -6}, {  6, -24,   6}, {  6,  -6, -24}, {  6,  -6,  24},
      {  6,   6, -24}, {  6,   6,  24}, {  6,  24,  -6}, {  6,  24,   6},
      {  9, -18, -15}, {  9, -18,  15}, {  9, -15, -18}, {  9, -15,  18},
      {  9,  15, -18}, {  9,  15,  18}, {  9,  18, -15}, {  9,  18,  15},
